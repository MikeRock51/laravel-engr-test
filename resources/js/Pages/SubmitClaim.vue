            ...
            <form @submit.prevent="submitClaim">
                ...
                <div class="mb-4">
                    ...
                    <select
                        ...
                        :class="{ 'border-red-500': errors.insurer_id }"
                    >
                    ...
                    <p v-if="errors.insurer_id" class="text-red-500 text-xs italic">{{ errors.insurer_id }}</p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    >
                    <p v-if="errors.provider_name" class="text-red-500 text-xs italic">{{ errors.provider_name }}</p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <p v-if="errors.specialty" class="text-red-500 text-xs italic">{{ errors.specialty }}</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        >
                        <p v-if="errors.encounter_date" class="text-red-500 text-xs italic">{{ errors.encounter_date }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="submission_date"
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            :class="{ 'border-red-500': errors.submission_date }"
                        >
                        <p v-if="errors.submission_date" class="text-red-500 text-xs italic">{{ errors.submission_date }}</p>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <p v-if="errors.priority_level" class="text-red-500 text-xs italic">{{ errors.priority_level }}</p>
                </div>
                    ...
                    <div v-for="(item, index) in form.items" :key="index" class="p-4 border rounded mb-4 bg-gray-50">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                >
                                <p v-if="errors['items.' + index + '.name']" class="text-red-500 text-xs italic">
                            ...
                            <div>
                                ...
                                >
                                <p v-if="errors['items.' + index + '.unit_price']" class="text-red-500 text-xs italic">
                            ...
                            <div>
                                ...
                                >
                                <p v-if="errors['items.' + index + '.quantity']" class="text-red-500 text-xs italic">
...
onMounted(async () => {
    try {
        ...
        form.value.submission_date = today;
    } catch (error) {
...
async function submitClaim() {
    ...
    try {
        const response = await axios.post('/api/claims/submit', form.value);
